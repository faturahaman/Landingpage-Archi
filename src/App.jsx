...
  const galleryImages = [
    { src: '/images/galery/aset (1).jpg', alt: 'Modern Living Room' },
    { src: '/images/galery/aset (10).jpg', alt: 'Modern Living Room' },
    { src: '/images/galery/aset (14).jpg', alt: 'Modern Living Room' },
    { src: '/images/galery/aset (15).jpg', alt: 'Modern Living Room' },
    { src: '/images/galery/aset (20).jpg', alt: 'Modern Living Room' },
  ];
...
  const whatsappMessage = "halo saya dari website ArchiFurni, saya ingin memesan jasa arsitektur dan furnitur.";
...
              <img
                src="../public/images/profile/WhatsApp Image 2025-06-12 at 12.00.16_2ab1de91.jpg"
                alt="Architect Portrait"
                className="w-full max-w-md mx-auto rounded-4xl shadow-2xl transform hover:scale-105 transition-transform duration-500 hover:rotate-1"
              />
            </div>
...
                  Syawal Property Unggul
                </span>
              </h2>
              <p className="text-lg text-gray-700 mb-6 leading-relaxed hover:text-gray-900 transition-colors duration-300">
                Berawal dari seorang **buruh bangunan**, pendiri kami Syawal Property Unggul, telah menempuh perjalanan luar biasa. Dengan dedikasi dan semangat pantang menyerah, beliau membangun keahlian langsung di lapangan konstruksi.
              </p>
              <p className="text-lg text-gray-700 mb-8 leading-relaxed hover:text-gray-900 transition-colors duration-300">
                Lebih dari **10 tahun pengalaman** dalam pembangunan gedung perkantoran, perumahan, dan berbagai properti, kini beliau hadir dengan usaha resmi, **ArchiFurni**. Kami menggabungkan keahlian teknis dengan kreativitas untuk menciptakan desain yang tidak hanya memenuhi kebutuhan klien, tetapi juga mencerminkan kepribadian dan gaya hidup mereka.
                
              </p>
...
              <p className="text-blue-100">Bogor, Jawa Barat</p>
            </div>
          </div>
          
...
                © 2025 Syawal Property Unggul. All rights reserved.
              </p>
            </div>
          </div>
        </div>
